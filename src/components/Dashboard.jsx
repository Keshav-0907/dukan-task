        ...
        <div className='h-fit w-[1216px] p-[32px] bg-[#FAFAFA]'>
            ...
            <div className='mt-[24px] flex gap-5 '>
                <div className='bg-[#146EB4] text-white w-1/3  rounded-[8px]'>
                    ...
                    <div className='flex justify-between items-center px-[20px] pb-[20px]'>
                        <div className='text-[32px]'>
                            ₹2,312.23
                        </div>
                        <div className='flex'>
                            <span className='text-[16px] underline'> 23 orders </span>
                    ...
                    <div className='flex justify-between bg-[#0E4F82] px-[24px] py-[8px] rounded-[8px]'>
                        <div>
                            Next payout date:
                        </div>
            ...
            <div className='pt-[32px] '>
                <div className='text-xl pb-[24px]'>
                    Transactions | This Month
                </div>

                <div className='flex gap-[12px] '>
                    <div className='px-[16px] py-[6px] bg-[#E6E6E6] text-[#808080] rounded-[40px] cursor-pointer'>
                        Payouts (22)
                    </div>

                    <div className='px-[16px] py-[6px] bg-[#146EB4] text-white rounded-[40px] cursor-pointer'>
                        Refunds (6)
                    </div>
                </div>
            </div>
            ...
            {/* Table */}
            <div className='p-[12px] mt-[24px] bg-white rounded-[8px]'>
                <div className='flex justify-between'>
                    <div class="px-[16px] py-[10px] bg-[#F2F2F2] space-x-2 flex items-center rounded-md w-[248px]">
